...
continue to hot-reload normally. Explicitly configured paths remain subscribed
even if a file is temporarily missing. Script request/history payload semantics
are unchanged.
